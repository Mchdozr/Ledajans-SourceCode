...
| `AGENT-HUB/serp_led_ekran_tracker.py` | `led ekran` için DuckDuckGo tabanlı sıra anlık görüntüsü + Çarşamba haftalık özet | `python3 AGENT-HUB/serp_led_ekran_tracker.py` |
