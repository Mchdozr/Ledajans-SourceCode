...
| `AGENT-HUB/serp_rank_tracker.py` | Google SERP sıra ölçümü ve haftalık rapor | `python3 AGENT-HUB/serp_rank_tracker.py` |
| `AGENT-HUB/run-serp-tracker.sh` | SERP tracker wrapper (cron uyumlu) | `bash AGENT-HUB/run-serp-tracker.sh` |
