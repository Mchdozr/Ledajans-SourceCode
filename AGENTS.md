...
| `AGENT-HUB/serp_rank_tracker.py` | `led ekran` SERP sıra ölçümü + haftalık rapor | `python3 AGENT-HUB/serp_rank_tracker.py --weekly` |
| `AGENT-HUB/run-serp-tracker.sh` | Cron/automation wrapper (günlük ölçüm) | `bash AGENT-HUB/run-serp-tracker.sh` |
