...
| `AGENT-HUB/serp_rank_tracker.py` | Anahtar kelime sıra ölçümü (`led ekran` vb.) | `python3 AGENT-HUB/serp_rank_tracker.py --weekly-report` |
| `AGENT-HUB/run-serp-weekly.sh` | Haftalık SERP ölçüm + rapor | `bash AGENT-HUB/run-serp-weekly.sh` |
