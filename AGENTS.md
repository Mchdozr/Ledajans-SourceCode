...
| `AGENT-HUB/weekly_serp_led_ekran.py` | «led ekran» için DuckDuckGo HTML ilk sayfa sırası; günlüğe yazar (Google değil) | `python3 AGENT-HUB/weekly_serp_led_ekran.py` |
| `AGENT-HUB/run-weekly-serp-led-ekran.sh` | Haftalık cron kabuğu (ör. Pazartesi 06:00) | `bash AGENT-HUB/run-weekly-serp-led-ekran.sh` |
