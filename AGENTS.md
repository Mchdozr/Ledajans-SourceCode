...
| `AGENT-HUB/serp_keyword_led_ekran.py` | `led ekran` için DuckDuckGo Lite organik sıra özeti; haftalık satır `AGENT-HUB/REPORTS/led-ekran-weekly-serp.md` | `python3 AGENT-HUB/serp_keyword_led_ekran.py --append-weekly` |
...
python3 AGENT-HUB/serp_keyword_led_ekran.py && echo "OK"
