...
| Saat | Faz | Komut |
|------|-----|-------|
| 09:30 | Keşif | `python scripts/run-coalition-cycle.py --phase discover` |
| 13:00 | Uygulama | `python scripts/coalition-apply.py` |
| 17:00 | Kapanış | `python scripts/run-coalition-cycle.py --phase close` |
