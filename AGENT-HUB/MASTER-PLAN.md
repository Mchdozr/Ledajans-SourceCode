...
### High (P1)
3. Mevcut para sayfalarda intent uyuşmazlığı (title/H1/meta ve içerik odak kayması)
4. İç link yapısında para sayfalara zayıf akış (kaynak-hedef-anchor dengesizliği)
5. Baseline SERP izleme eksikliği (ölçülemeyen ilerleme riski)
